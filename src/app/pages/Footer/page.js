        ...
        <div className="flex flex-wrap bg-[#141c27a6] pl-5 pr-5 text-white text-[7px] pt-5 pb-5 justify-around items-center">
          <div className="text-[8px] flex-col">
            ...
            <span>
              <p className="mb-2">
                B ANG.in Address : Jl.
                <br /> Riaz Road Jutial, Gilgit,Pakistan,
                <br />
                Hairdary Muhallah, Kote <br /> Jutial, Near Rupani Academy
                202100
                <br /> +092 3188278882 arifkoyani@gmail.com
              </p>
              <p>
                +092 03188278882
                <br />
          ...
          <div className="flex flex-col gap-2 p-1 items-center">
            ...
            <span className="flex flex-col text-sm gap-3">
              <p>helpFAQS</p>
              <p>Press</p>
              <p>Affilates</p>
            </span>
...
<footer class="bg-[#000000b0] text-white dark:bg-gray-900">
    ...
    <div class="px-4 py-6 bg-[#d78a05b9]  text-white md:flex md:items-center md:justify-between">
        <span class="text-sm text-white sm:text-center">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
